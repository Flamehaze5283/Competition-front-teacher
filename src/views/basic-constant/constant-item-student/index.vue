<template>
	<div>
		...
		<el-dialog :title="title" :visible.sync="show" :close-on-click-modal="false" width="500px">
			<ConstantItemStudentEdit v-if="show" :show.sync="show" @getData="getData()" :editid="editid"></ConstantItemStudentEdit>
		</el-dialog>
	</div>
</template>

<script>
	import ConstantItemStudentEdit from '@/views/basic-constant/constant-item-student/edit'
	export default {
