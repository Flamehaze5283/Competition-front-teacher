<template>
	<div>
		...
		<el-dialog :title="title" :visible.sync="show" :close-on-click-modal="false" width="500px">
			<ConstantItemTeacherEdit v-if="show" :show.sync="show" @getData="getData()" :editid="editid"></ConstantItemTeacherEdit>
		</el-dialog>
	</div>
</template>

<script>
	import ConstantItemTeacherEdit from '@/views/basic-constant/constant-item-teacher/edit'
	export default {
